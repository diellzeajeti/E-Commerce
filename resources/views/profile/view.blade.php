     ...
     @csrf
        ...
        <div class="grid grid-cols-2 gap-3 mb-3">
            <x-input
                type="text"
                name="first-name"
                value="{{old('first-name', $customer->first_name)}}"
            ...
            <x-input
                type="text"
                name="last-name"
                value="{{old('last-name', $customer->last_name)}}"
            ...
            <div class="mb-3">
                ...
                <h2 class="test-xl mt-6 font-semibold mb-2">Billing Address</h2>
                <div class="grid grid-cols-2 gap-3 mb-3">
                    <div>
                        <x-input
                            type="text"
                       ...
                       <x-input type="select"
                            ...
                            <template x-for="country of countries" :key="country.code">
                                <option :selected="country.code === billingAddress.country_code"
                                        :vlaue="country.code" x-text="country.name"></option>
                            </template>
                        </x-input>
                    </div>
                <div>
                    ...
                    <x-input type="select"
                             ...
                             <template x-for="[code, state] of Object.entries(billingCountryStates)"
                                ...
                                <option :selected="code === billingAddress.state"
                                        :vlaue="code" x-text="state"></option>
                       </template>
                      </x-input>
                    </template>
                    <template x-if="!billingCountryStates">
